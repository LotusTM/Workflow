...
3. **Если у сайта есть верстка, и она хороша — лучше использовать идентичные CSS-классам названия для компонентов и страниц**
  ...
  К сожалению, не на всех проектах это возможно, но для самых новых, где используется современная верстка, это более чем возможно.
...
4. **Используйте модульные смарт-объекты**
  ...
  Немного более подробно: https://github.com/mobify/handbooks/tree/master/photoshop-handbook
...
4. **Используйте группы для объединения слоев в компоненты и слои**
  ...
  Главное при этом помнить про золотую середину — слишком мелкие компоненты не всегда разумно объединять в группу тоже.
